            ...
            <div class="col-lg-4 col-md-6 text-center">
                <div class="team-style d-flex flex-column align-items-center">
                    ...
                    <span class=" col-md-10" style="max-width: 100%;">For clients looking for comprehensive linen management solutions, we offer a tailored approach
                        ...
                        a strategy that ensures you always have clean, high-quality linens on hand to meet the needs of
                        your guests or patients</span>
        ...
        <div class="row">
            <div class="col-lg-4 col-md-6">
                <div class="featured-imagebox featured-imagebox-gallery">
                    <a href="assets/img/gallery-style-1.jpg" data-fancybox="gallery">
                        <div class="featured-link">
                            <div class="featured-thumbnail">
                                <img class="img-fluid w-100" width="390" height="390"
                                    src="assets/img/gallery-style-1.jpg" alt="gallery-img">
                            </div>
                ...
                <div class="featured-imagebox featured-imagebox-gallery">
                    <a href="assets/img/gallery-style-2.jpg" data-fancybox="gallery">
                        <div class="featured-link">
                            <div class="featured-thumbnail">
                                <img class="img-fluid w-100" width="390" height="390"
                                    src="assets/img/gallery-style-2.jpg" alt="gallery-img">
                            </div>
                            <div class="featured-overlay"></div>
                        </div>
                    </a>
                ...
                <div class="featured-imagebox featured-imagebox-gallery">
                    <a href="assets/img/gallery-style-3.jpg" data-fancybox="gallery">
                        <div class="featured-link">
                            <div class="featured-thumbnail">
                                <img class="img-fluid w-100" width="390" height="390"
                                    src="assets/img/gallery-style-3.jpg" alt="gallery-img">
                            </div>
                            <div class="featured-overlay"></div>
                        </div>
                    </a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="featured-imagebox featured-imagebox-gallery">
                    <a href="assets/img/gallery-style-6.jpg" data-fancybox="gallery">
                        <div class="featured-link">
                            <div class="featured-thumbnail">
                                <img class="img-fluid w-100" width="390" height="390"
                                    src="assets/img/gallery-style-6.jpg" alt="gallery-img">
                            </div>
                            <div class="featured-overlay"></div>
                        </div>
                    </a>
                ...
                <div class="featured-imagebox featured-imagebox-gallery">
                    <a href="assets/img/gallery-style-4.jpg" data-fancybox="gallery">
                        <div class="featured-link">
                            <div class="featured-thumbnail">
                                <img class="img-fluid w-100" width="390" height="390"
                                    src="assets/img/gallery-style-4.jpg" alt="gallery-img">
                            </div>
                            <div class="featured-overlay"></div>
                        </div>
                    </a>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="featured-imagebox featured-imagebox-gallery">
                    <a href="assets/img/gallery-style-5.jpg" data-fancybox="gallery">
                        <div class="featured-link">
                            <div class="featured-thumbnail">
                                <img class="img-fluid w-100" width="390" height="390"
                                    src="assets/img/gallery-style-5.jpg" alt="gallery-img">
                            </div>
                            <div class="featured-overlay"></div>
                        </div>
                    </a>
                ...
                <div class="featured-imagebox featured-imagebox-gallery">
                    <a href="assets/img/gallery-style-7.jpg" data-fancybox="gallery">
                        <div class="featured-link">
                            <div class="featured-thumbnail">
                                <img class="img-fluid w-100" width="390" height="390"
                                    src="assets/img/gallery-style-7.jpg" alt="gallery-img">
                            </div>
                            <div class="featured-overlay"></div>
                        </div>
                    </a>
