    ...
    <div class="row">
      ...
      <div class="col-lg-3 col-md-6">
        <div class="widget-title">
          ...
          <div class="boder"></div>
            <ul >
            <li><i class="fa-solid fa-angle-right"></i><a href="javascript:void(0)">LINEN MANAGEMENT</a></li>
              <li><i class="fa-solid fa-angle-right"></i><a href="javascript:void(0)">WASHING SERVICES</a></li>
              <li><i class="fa-solid fa-angle-right"></i><a href="javascript:void(0)">CUSTOMIZED SOLUTIONS</a></li>
      ...
      <div class="col-lg-3 col-md-6">
        <div class="widget-title">
          ...
          <div class="boder"></div>
            <ul >
            <li><i class="fa-solid fa-angle-right"></i> <a href="<?php echo base_url('about');?>">ABOUT US</a></li>
              <li><i class="fa-solid fa-angle-right"></i> <a href="<?php echo base_url('contact');?>">CONTACT US</a></li>
      ...
      <div class="col-lg-3 col-md-6">
        <div class="widget-title">
          ...
          <div class="get-in-touch  d-flex align-items-center">
            ...
            <div>
              <span></span> 
              <h6><a href="mailto:mayanksharma@bharatlaundry.co">mayanksharma@bharatlaundry.co</a></h6>
            </div>
          </div>
          <div class="get-in-touch">
            <i>
              <svg version="1.1" xml:space="preserve" width="682.66669" height="582.66669" viewBox="0 0 682.66669 682.66669" xmlns="http://www.w3.org/2000/svg"><clipPath clipPathUnits="userSpaceOnUse"><path d="M 0,512 H 512 V 0 H 0 Z"></path></clipPath><g transform="matrix(1.3333333,0,0,-1.3333333,0,682.66667)"><g><g clip-path="url(#clipPath2333)"><g transform="translate(256,92)"><path d="m 0,0 c -126.964,143.662 -160,165.23 -160,240 0,88.366 71.634,160 160,160 88.365,0 160,-71.634 160,-160 C 160,165.854 130.212,147.337 0,0 Z" style="fill:none;stroke:#fff;stroke-width:40;stroke-linecap:square;stroke-linejoin:miter;stroke-miterlimit:10;stroke-dasharray:none;stroke-opacity:1"></path></g><g transform="translate(316,372)"><path d="m 0,0 -80,-80 -40,40" style="fill:none;stroke:#fff;stroke-width:40;stroke-linecap:square;stroke-linejoin:miter;stroke-miterlimit:10;stroke-dasharray:none;stroke-opacity:1"></path></g></g></g></g>
              </svg>
            </i>
            <div>
              <span class="pt-2 pb-0"> Okay Plus, 203, Malviya Nagar Industrial Area, Jaipur 302017</span>
            </div>
          </div>
        </div>
      </div>
...
<!-- LIGHTBOX -->
    <div id="lightbox" class="lightbox clearfix">
        <div class="white_content">
          ...
          <figure>
            <img src="assets/img/desktop-menu-img.jpg" alt="Desktop Menu Image">
          </figure>
          <h3>Get in touch</h3>
          <p class="num"><i>
          ...
          <p class="num"><i>
            ...
            </i>65 Allerton Street New Delhi India</p>
        ...
        <div class="flex-img">
            <div class="form-box">
                ...
                <form>
                        <div class="row">
                            <div class="col-lg-6">
                                <input placeholder="Pick-Up Date" type="text" onfocus="(this.type = 'date')"  id="date">
                            </div>
                            <div class="col-lg-6">
                                <input placeholder="Delivery Date" type="text" onfocus="(this.type = 'date')"  id="date">
                            </div>
                            <div class="col-lg-6">
            ...
            <img src="assets/img/box.jpg" alt="box">
        </div>
